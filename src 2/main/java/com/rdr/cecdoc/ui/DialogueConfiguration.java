...
public final class DialogueConfiguration extends JDialog {
    ...
    private static final System.Logger JOURNAL = System.getLogger(DialogueConfiguration.class.getName());
    ...
    private void choisirDossierSortie() {
        ...
        if (!valeur.isEmpty()) {
            try {
                ...
                JOURNAL.log(System.Logger.Level.DEBUG, "Chemin de dossier de sortie invalide : " + valeur, ex);
