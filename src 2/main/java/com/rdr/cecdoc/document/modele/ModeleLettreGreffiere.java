...
public final class ModeleLettreGreffiere extends ModeleDocumentAbstrait<DonneesDossier> {
    ...
    private void ajouterCorps(RedactriceDocument redactrice, DonneesDossier donneesDossier) {
        ...
        String ligneProfession = nettoyer(donneesDossier.professionExercee());
    ...
    private String identiteAffichee(DonneesDossier donneesDossier) {
        String prenomsUsage = donneesDossier.changementPrenoms() ? nettoyer(donneesDossier.prenomsUsage()) : nettoyer(donneesDossier.prenomsEtatCivil());
        return FormateurIdentite.identiteAvecEtatCivil(prenomsUsage, donneesDossier.prenomsEtatCivil(), donneesDossier.nomFamilleMajuscules());
    }
