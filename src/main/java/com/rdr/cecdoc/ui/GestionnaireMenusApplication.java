...
final class GestionnaireMenusApplication {
    ...
    private final Runnable actionDon;
    ...
    GestionnaireMenusApplication(Supplier<TokensTheme> fournisseurTheme, Supplier<PreferenceThemeApplication> fournisseurPreferenceTheme, ActionTheme actionTheme, Runnable actionParametres, Runnable actionImporterConfiguration, Runnable actionExporterConfiguration, Runnable actionGuide, Runnable actionRechercheMiseAJour, Runnable actionAPropos, Runnable actionDon) {
        ...
        this.actionDon = Objects.requireNonNull(actionDon, "actionDon");
    ...
    JMenuBar construireBarreMenusPrincipale() {
        ...
        menuFichier.add(creerElementMenu("Importer une configuration", KeyEvent.VK_I, null, actionImporterConfiguration, "Importer une configuration", "Importe une configuration CECDoc au format XML", true));
        ...
        menuAide.add(creerElementMenu("Me faire un don", KeyEvent.VK_D, null, actionDon, "Me faire un don", "Ouvre la fenêtre de don Bitcoin, Monero ou GitHub Sponsors", true));
    ...
    void appliquerThemeMenus() {
        ...
        barreMenusPrincipale.setBorder(BorderFactory.createCompoundBorder(new LineBorder(theme.palette().border(), 1, true), new EmptyBorder(3, 6, 3, 6)));
    ...
    private JMenuItem creerElementMenu(String texte, int mnemonic, KeyStroke accelerateur, Runnable action, String nomAccessible, String descriptionAccessible, boolean actifPendantTache) {
