...
public final class SelecteurThemeStrategie implements SelecteurTheme {
    ...
    public SelecteurThemeStrategie(Iterable<StrategieTheme> strategies) {
        ...
        if (!this.strategies.containsKey(ModeTheme.TRANS) || !this.strategies.containsKey(ModeTheme.NON_BINAIRE) || !this.strategies.containsKey(ModeTheme.LESBIEN) || !this.strategies.containsKey(ModeTheme.INTERSEXE) || !this.strategies.containsKey(ModeTheme.RAINBOW) || !this.strategies.containsKey(ModeTheme.COMMUNISTE)) {
