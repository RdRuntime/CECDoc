...
public final class StyliseurBoutonTheme {
    ...
    private static final class ButtonStateChangeListener implements ChangeListener {
        private final TokensEtatBouton tokens;
        private final TokensTheme theme;

        private ButtonStateChangeListener(TokensEtatBouton tokens, TokensTheme theme) {
            this.tokens = tokens;
            this.theme = theme;
        }
