...
public final class DonneesLettreAdministration {
    ...
    public String identiteEntete() {
        String ancienPrenom = prenomsEtatCivil.isBlank() ? "" : " (" + prenomsEtatCivil + ")";
        return prenomUsage + ancienPrenom + " " + nomMajuscules();
    }

    public String premierParagrapheModifications() {
        StringBuilder resultat = new StringBuilder();
        if (changementPrenom) {
            resultat.append("Mes prénoms ont été modifié de ")
                    .append(prenomNaissance)
                    .append(" ")
                    .append(nomMajuscules())
                    .append(" à ")
                    .append(prenomsEtatCivil)
                    .append(" ")
                    .append(nomMajuscules())
                    .append(". ");
        }
        if (changementSexe) {
            resultat.append("Mon sexe à l'état civil a été modifié d'un sexe ")
                    .append(sexeAvant)
                    .append(" à un sexe ")
                    .append(sexeApres)
                    .append(". ");
