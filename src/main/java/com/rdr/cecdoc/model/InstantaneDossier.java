...
public record InstantaneDossier(boolean changementPrenoms, boolean pronomNeutre, String prenomsEtatCivil,
                                String prenomsUsage, String nomFamille, String dateNaissance, String lieuNaissance,
                                String sexeEtatCivil, String adresse, String tribunal, String recit,
                                String villeActuelle, List<String> piecesJustificatives, String nationalite,
    ...
    public InstantaneDossier(boolean changementPrenoms, boolean pronomNeutre, String prenomsEtatCivil, String prenomsUsage, String nomFamille, String dateNaissance, String lieuNaissance, String sexeEtatCivil, String adresse, String tribunal, String recit, String villeActuelle, List<String> piecesJustificatives, String nationalite, String profession, String situationMatrimoniale, String situationEnfants, boolean pacsContracte) {
        this(changementPrenoms, pronomNeutre, prenomsEtatCivil, prenomsUsage, nomFamille, dateNaissance, lieuNaissance, sexeEtatCivil, adresse, tribunal, recit, villeActuelle, piecesJustificatives, nationalite, profession, situationMatrimoniale, situationEnfants, pacsContracte, List.of());
    }
